...
window.addEventListener('load', () => {
    ...
    // hovered upon.
    pianoSvg.addEventListener('keydown', (event) => {

        // Calling the function handleKeyPress & setting setting 
        // event.srcElement as parameter.
        pianoOnKeyPress(event.srcElement);

    });

    // Using mouseout event to determine which element was
    // hovered upon.
    pianoSvg.addEventListener('keyup', (event) => {

        // Calling the function handleKeyRemoval & setting setting 
        // event.srcElement as parameter.
        pianoOnKeyRemoval(event.srcElement);
